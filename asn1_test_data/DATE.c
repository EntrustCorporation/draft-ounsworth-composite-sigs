...
int
DATE_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
DATE_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
DATE_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	DATE_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
DATE_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
DATE_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DATE_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
DATE_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
DATE_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
